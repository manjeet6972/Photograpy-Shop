  ...
  return (
    <>
      <div className={`relative bg-gradient-to-b ${color} ${shadow}
        grid items-center ${ifExists ? 'justify-items-start' : 'justify-items-center'} rounded-xl py-5 px-5 transition-all duration-700
        ...
        <div className={`grid items-center ${ifExists ? 'justify-items-start' : 'justify-items-center'}`}>
          ...
          <div className='flex items-center gap-3'>
            ...
            <button type='button' className='bg-white/90 blur-effect-theme button-theme px-2 py-1
