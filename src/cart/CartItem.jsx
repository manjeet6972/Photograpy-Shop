          ...
          <div className='grid items-center gap-4'>
            ...
            <div className='flex items-center justify-around w-full'>
              ...
              <button type='button' onClick={onDecreaseItemQTY}
                className='bg-theme-cart rounded w-6 h-6 lg:w-5 
              lg:h-5 flex items-center justify-center active:scale-90'>
              ...
              w-7 h-6 lg:h-5 lg:w-6 flex items-center justify-center'>
                {cartQuantity}</div>
